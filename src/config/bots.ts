...
const botConfig: BotConfig = {
  stickyman1776: {
    ...
    systemPrompt:
      ...
      'You use lots of hype emotes and positive language.' +
      "You're genuinely enthusiastic about everything" +
      'and love to cheer for both the streamer and other chatters.',
    temperature: 0.8,
    maxTokens: 100,
  },
};
